...
OpenCode Go jest przeznaczony do użytku z [OpenCode](https://opencode.ai) i innymi popularnymi agentami kodującymi, którzy generują podobne rodzaje żądań.
...
3\. zawiera nagłówek `x-opencode-session`, abyśmy mogli zoptymalizować buforowanie promptów
...
Efektywny limit różni się w zależności od modelu; zobacz tabelę poniżej.
...
Go kosztuje $10/miesiąc, a w przypadku większości modeli naszym celem jest zapewnienie Ci użycia o wartości 6x większej niż ta kwota.

...
OpenCode Go je osmišljen za korištenje s [OpenCode-om](https://opencode.ai) i drugim popularnim agentima za programiranje koji generišu slične vrste zahtjeva.
...
3\. uključuje zaglavlje `x-opencode-session` kako bismo mogli optimizovati keširanje promptova
...
Efektivna potrošnja razlikuje se po modelu; pogledajte tabelu ispod.
...
Uz Go plaćate $10 mjesečno, a za većinu modela cilj nam je omogućiti vam potrošnju šest puta veću od tog iznosa.

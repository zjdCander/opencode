...
OpenCode Go er designet til brug med [OpenCode](https://opencode.ai) og andre populære kodningsagenter, der genererer lignende typer anmodninger.
...
3\. inkluderer `x-opencode-session`-headeren, så vi kan optimere prompt-caching
...
Det effektive forbrug varierer efter model; se tabellen nedenfor.
...
Med Go betaler du $10/måned, og for de fleste modeller sigter vi mod at give dig 6x så meget i forbrug.

...
صُمّم OpenCode Go للاستخدام مع [OpenCode](https://opencode.ai) وغيره من وكلاء البرمجة الشائعين الذين ينشئون أنواعًا مماثلة من الطلبات.
...
3\. تتضمن ترويسة `x-opencode-session` حتى نتمكن من تحسين التخزين المؤقت للمطالبات

## حدود الاستخدام

يتضمن OpenCode Go الحدود الأساسية التالية:

- **حد 5 ساعات** — استخدام بقيمة $12
- **الحد الأسبوعي** — استخدام بقيمة $30
- **الحد الشهري** — استخدام بقيمة $60

يختلف الحد الفعلي حسب النموذج؛ راجع الجدول أدناه.
...
- Omen Alpha — ‏300 input، و40,000 cached، و100 output tokens لكل طلب
...
مع Go، تدفع $10 شهريًا، ونهدف لمعظم النماذج إلى منحك استخدامًا بقيمة تعادل 6 أضعاف هذا المبلغ.
...
| Omen Alpha                   | غير مستخدَمة  | 0 أيام             |
...
- **DeepSeek V4 Flash:** تُجدَّد اتفاقية ZDR شهريًا. الاتفاقية الحالية سارية حتى 30 سبتمبر 2026.

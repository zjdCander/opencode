...
OpenCode Go er utviklet for bruk med [OpenCode](https://opencode.ai) og andre populære kodeagenter som genererer lignende typer forespørsler.
...
3\. inkluderer `x-opencode-session`-headeren, slik at vi kan optimalisere promptbufring

## Bruksgrenser

OpenCode Go inkluderer følgende basisgrenser:

- **5-timers grense** — $12 i bruk
- **Ukentlig grense** — $30 i bruk
- **Månedlig grense** — $60 i bruk

Den effektive bruken varierer etter modell; se tabellen nedenfor.
...
Med Go betaler du $10/måned, og for de fleste modeller har vi som mål å gi deg seks ganger så mye bruk.
...
| Omen Alpha                   | Brukes ikke   | 0 dager         |
...
- **DeepSeek V4 Flash:** ZDR-avtalen fornyes månedlig. Den gjeldende avtalen er gyldig til og med 30. september 2026.

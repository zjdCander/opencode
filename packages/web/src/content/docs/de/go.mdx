...
OpenCode Go wurde für die Verwendung mit [OpenCode](https://opencode.ai) und anderen beliebten Coding-Agenten entwickelt, die ähnliche Arten von Anfragen erzeugen.
...
3\. den Header `x-opencode-session` enthält, damit wir das Prompt-Caching optimieren können
...
Das effektive Kontingent variiert je nach Modell; siehe die Tabelle unten.
...
Mit Go zahlst du $10/Monat, und bei den meisten Modellen ist unser Ziel, dir dafür das Sechsfache dieses Betrags als Nutzungsguthaben zu bieten.

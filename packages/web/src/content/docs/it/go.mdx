...
OpenCode Go è progettato per essere utilizzato con [OpenCode](https://opencode.ai) e altri agenti di programmazione popolari che generano tipi di richieste simili.
...
3\. includa l'header `x-opencode-session` in modo da consentirci di ottimizzare il caching dei prompt
...
La quota effettiva varia in base al modello; consulta la tabella seguente.
...
Con Go, paghi $10/mese e, per la maggior parte dei modelli, puntiamo a offrirti un utilizzo pari a 6 volte tale importo.

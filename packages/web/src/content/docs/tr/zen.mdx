...
- Union Alpha Free, sınırlı bir süre için OpenCode'da sunulan gizli bir modeldir. Sağlayıcısı sıfır saklama politikası uygular ve verilerinizi model eğitimi için kullanmaz.

...
OpenCode Go ออกแบบมาเพื่อใช้กับ [OpenCode](https://opencode.ai) และเอเจนต์เขียนโค้ดยอดนิยมอื่นๆ ที่สร้างคำขอในลักษณะเดียวกัน
...
3\. มีส่วนหัว `x-opencode-session` เพื่อให้เราสามารถปรับการแคชพรอมต์ให้เหมาะสมได้
...
ขีดจำกัดการใช้งานที่มีผลแตกต่างกันไปตามโมเดล โปรดดูตารางด้านล่าง
...
สำหรับ Go คุณจ่าย $10/เดือน และสำหรับโมเดลส่วนใหญ่ เราตั้งเป้าที่จะมอบปริมาณการใช้งานให้คุณ 6 เท่าของจำนวนดังกล่าว
